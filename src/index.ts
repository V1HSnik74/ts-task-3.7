import {Status, Priority, User, Todo} from "./types";
...
const user : User = {
    ...
    displayTodos() {
        ...
        this.todos.forEach((todo: Todo) => console.log(`${todo.todo} (Priority: ${todo.priority})`));
    },
    ...
    displayActiveTodos() {
        ...
        this.todos
            .filter((todo: Todo) => todo.priority !== Priority.HIGH)
            .forEach((todo: Todo) => console.log(`${todo.todo} (Priority: ${todo.priority})`));
    }
};
